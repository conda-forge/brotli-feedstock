...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/brotli-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/brotli-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add brotli brotli-bin brotli-python libbrotlicommon libbrotlidec libbrotlienc
# for installing globally
pixi global install brotli brotli-bin brotli-python libbrotlicommon libbrotlidec libbrotlienc
```
...
It is possible to list all of the versions of `brotli` available on your platform:
...
```
pixi search brotli --channel conda-forge
```
